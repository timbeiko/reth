    ...
    DB: Database,
{
    ...
    fn take_shard<T>(&self, key: T::Key) -> Result<Vec<u64>, TransactionError>
    where
    ...
    DB: Database,
{
    ...
    pub fn unwind_log_history_indices(
        ...
        let mut log_address_history_cursor = self.cursor_write::<tables::LogAddressHistory>()?;
        ...
        let mut log_topic_history_cursor = self.cursor_write::<tables::LogTopicHistory>()?;
